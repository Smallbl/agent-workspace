...
## 智能体框架（2026-03-29确立，2026-03-31更新开发团队）

| 角色 | 编号 | 职责范围 |
|------|------|---------|
| 🧠 豆浆（主控大脑） | main | 统筹规划、任务调度、质量把控、项目记忆 |
| 👨‍💻 前端官 | subagent-frontend | 界面开发、UI优化、交互体验 |
| 👨‍💻 后端官 | subagent-backend | 接口开发、数据处理、业务逻辑 |
| 🧪 测试官 | subagent-test | 功能测试、回归测试、Bug记录 |
...
- 开发智能体负责执行：完成开发后通知测试官验证
- 测试官负责验证：发现Bug记录并上报，不自行修复
